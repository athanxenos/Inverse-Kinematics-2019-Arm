function [P_end] = plotArm_2019(theta)
%plotArm_2019
...
[T01,T02,T03,T04,~,~,P_end] = FK_2019(theta);
...
Q1=[P1(1,1) P2(1,1) P3(1,1) P4(1,1) P_end(1,1)];
Q2=[P1(1,2) P2(1,2) P3(1,2) P4(1,2) P_end(1,2)];
Q3=[P1(1,3) P2(1,3) P3(1,3) P4(1,3) P_end(1,3)];
...
%Print final position of end effector
%text(P_end(1,1),P_end(1,2),['  (', num2str(P_end(1,1),3), ', ', num2str(P_end(1,2),3),',', num2str(P_end(1,3),3) ')']);
end
